...
public static String analyzeDishCost(Dish dish) {
    return (dish.costInCents < AVERAGE_COST_OF_DISH_IN_CENTS) ? "Less expensive than average" : "More expensive than average";
}
...
public static String analyzeCostDollar(Dish dish){
    return (dish.costInCents < lessThanADollar) ? "Dollar Find!" : "No go deal!";
    }
}
